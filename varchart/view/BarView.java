...
import varchart.view.gl.BarGL;

public class BarView extends VarviewWindow {

	private static final long serialVersionUID = 1L;

	private BarGL glManager;
	private ReporterTask reporterTask;

	public int worldWidth, worldHeight;
	public double[][] reporterValueMatrix;

	public BarView(String title, ReporterTask rt, Integer id) {
		super(title, id);
		reporterTask = rt;
